...
/**
 ...
 @return 解档对象
 */
+ (nullable id)ch_unarchiveObjectWithData:(NSData *)data exception:(__autoreleasing NSException **)exception;
...
/**
 ...
 @return 解档对象
 */
+ (nullable id)ch_unarchiveObjectWithFile:(NSString *)path exception:(__autoreleasing NSException **)exception;
